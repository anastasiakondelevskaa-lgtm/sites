...
DAYS = [
    ...
    dict(name="Четвер", mood="майже вихідні",
         ...
         meals=[
             dict(type="breakfast", name="Хрусткий лаваш-тост із яйцем та сиром", kbzhu=(390,25,18,31), photo=PH["lavash_toast"], page=11, link_label="Сніданки"),
             dict(type="lunch", name="Курячі котлетки з сиром + гречка + овочі", kbzhu=(480,42,14,46), photo=PH["kotletky_syr"], page=12),
...
if __name__ == "__main__":
    ...
    with open("index.html", "w", encoding="utf-8") as f:
        f.write(content)
    print(f"Inserted {len(build())} pages for week 1.")
